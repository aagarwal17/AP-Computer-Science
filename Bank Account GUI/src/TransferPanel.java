...
public class TransferPanel extends JPanel
{
	...
	public TransferPanel(ArrayList<BankAccount> total)
	{
		...
		entername1.setPreferredSize(new Dimension(200,30));
		add(entername1, gbc);
		...
		enterbalance1.setPreferredSize(new Dimension(200,30));
		...
		entername2.setPreferredSize(new Dimension(200,30));
		add(entername2, gbc);
		...
		enterbalance2.setPreferredSize(new Dimension(200,30));
		...
		enteramount.setPreferredSize(new Dimension(200,30));
		add(enteramount,gbc);
